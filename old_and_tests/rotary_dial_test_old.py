...
Script can be interrupted by ctrl+c
"""
...
rotary_dial_callback_evt = threading.Event()


def on_rotary_dial_interrupt(arg):
	rotary_dial_callback_evt.set()
...
def run_loop():
	while True:
		...
		curr_time = new_time
		rotary_dial_callback_evt.clear()
